            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-12 mt-3">
                    <div class="float-left">
                        <a class="btn btn-success" href="{{ route('data-pns.index') }}"> Kembali</a>
                    </div>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h4 class="card-title">Data PNS
                                <b>{{ dekripsihillcipher(utf8_decode($datanya->nama_pns)) }}</b>
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-4">
                                    <a href="{{ url('datafoto_pns/' . $datanya->foto_pns) }}" data-toggle="lightbox"
                                        data-title="Foto {{ dekripsihillcipher(utf8_decode($datanya->nama_pns)) }}"
                                        data-gallery="gallery">
                                        <img src="{{ url('datafoto_pns/' . $datanya->foto_pns) }}" class="img-fluid mb-2"
                                            alt="Foto {{ dekripsihillcipher(utf8_decode($datanya->nama_pns)) }}">
                                    </a>
                                </div>
                                <div class="col-sm-8">
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="1%" align="center">:</td>
                                                <td><b>{{ dekripsihillcipher(utf8_decode($datanya->nip)) }}</b></td>
                                            </tr>
                                            <tr>
                                                <td width="25%">Nama Lengkap</td>
                                                <td width="1%" align="center">:</td>
                                                <td><b>{{ dekripsihillcipher(utf8_decode($datanya->nama_pns)) }}</b></td>
                                            </tr>
                                            <tr>
                                                @php
                                            ...
                                            <tr>
                                                ...
                                                <td width="1%" align="center">:</td>
                                                <td><b>{{ $datanya->subbidang->nama_sub_bidang != null ? $datanya->subbidang->nama_sub_bidang : '' }}</b>
                                                </td>
                                            </tr>
                                            <tr>
