            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('data-subbidang.update', $datanya->id_sub_bidang) }}" method="POST"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_sub_bidang" class="form-control"
                                                    placeholder="Nama Bidang" value="{{ $datanya->nama_sub_bidang }}"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="singkatan" class="form-control"
                                                    placeholder="Singkatan" value="{{ $datanya->singkatan }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
