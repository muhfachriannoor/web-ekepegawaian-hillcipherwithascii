            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-12 mt-3">
                    <div class="float-left">
                        <a class="btn btn-success" href="<?php echo e(route('data-nonpns.index')); ?>"> Kembali</a>
                    </div>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h4 class="card-title">Data Non PNS
                                <b><?php echo e(dekripsihillcipher(utf8_decode($datanya->nama_non_pns))); ?></b>
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-4">
                                    <a href="<?php echo e(url('datafoto_nonpns/' . $datanya->foto_non_pns)); ?>" data-toggle="lightbox"
                                        data-title="Foto <?php echo e(dekripsihillcipher(utf8_decode($datanya->nama_non_pns))); ?>"
                                        data-gallery="gallery">
                                        <img src="<?php echo e(url('datafoto_nonpns/' . $datanya->foto_non_pns)); ?>"
                                            class="img-fluid mb-2"
                                            alt="Foto <?php echo e(dekripsihillcipher(utf8_decode($datanya->nama_non_pns))); ?>">
                                    </a>
                                </div>
                                <div class="col-sm-8">
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="1%" align="center">:</td>
                                                <td><b><?php echo e(dekripsihillcipher(utf8_decode($datanya->nama_non_pns))); ?></b>
                                                </td>
                                            </tr>
                                            <tr>
                                                <?php
                                            ...
                                            <tr>
                                                ...
                                                <td width="1%" align="center">:</td>
                                                <td><b><?php echo e($datanya->subbidang->nama_sub_bidang); ?></b></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="1%" align="center">:</td>
                                                <td><b><?php echo e(dekripsihillcipher(utf8_decode($datanya->nomor_npwp))); ?></b></td>
                                            </tr>
                                            <tr>
                                                <td width="25%">Nomor BPJS Ketenagakerjaan</td>
                                                <td width="1%" align="center">:</td>
                                                <td><b><?php echo e(dekripsihillcipher(utf8_decode($datanya->nomor_bpjs_ketenagakerjaan))); ?></b>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="1%" align="center">:</td>
                                                <td><b><?php echo e(dekripsihillcipher(utf8_decode($datanya->tahun_masuk))); ?></b>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
<?php echo $__env->make('admin/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-kepegawaian-hillcipher\resources\views/admin/lihat-nonpns.blade.php ENDPATH**/ ?>