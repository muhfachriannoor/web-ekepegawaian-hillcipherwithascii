            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo e(route('data-pns.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="reservationdate"
                                                    ...
                                                    <input type="text" name="tanggal_lahir"
                                                        ...
                                                        data-target="#reservationdate" placeholder="31/12/2000">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="pangkat_golongan" class="form-control" required>
                                                    ...
                                                    <option value="Juru Muda Tingkat 1 (I/b)">Juru Muda Tingkat 1 (I/b)
                                                    </option>
                                                    <option value="Juru (I/c)">Juru (I/c)</option>
                                                    <option value="Juru Tingkat 1 (I/d)">Juru Tingkat 1 (I/d)</option>
                                                    <option value="Pengatur Muda (II/a)">Pengatur Muda (II/a)</option>
                                                    <option value="Pengatur Muda Tingkat 1 (II/b)">Pengatur Muda Tingkat 1
                                                        (II/b)</option>
                                                    <option value="Pengatur (II/c)">Pengatur (II/c)</option>
                                                    <option value="Pengatur Tingkat 1 (II/d)">Pengatur Tingkat 1 (II/d)
                                                    </option>
                                                    <option value="Penata Muda (III/a)">Penata Muda (III/a)</option>
                                                    <option value="Penata Muda Tingkat 1 (III/b)">Penata Muda Tingkat 1
                                                        (III/b)</option>
                                                    <option value="Penata (III/c)">Penata (III/c)</option>
                                                    <option value="Penata Tingkat 1 (III/d)">Penata Tingkat 1 (III/d)
                                                    </option>
                                                    <option value="Pembina (IV/a)">Pembina (IV/a)</option>
                                                    <option value="Pembina Tingkat 1 (IV/b)">Pembina Tingkat 1 (IV/b)
                                                    </option>
...
<?php echo $__env->make('admin/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Data Fachri\Kampus\e-kepegawaian-hillcipher\resources\views/admin/tambah-pns.blade.php ENDPATH**/ ?>