            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-12 mt-3">
                    <div class="float-left">
                        <a class="btn btn-success" href="<?php echo e(route('data-pns.create')); ?>"> Tambah Data</a>
                        <a class="btn btn-success" href="<?php echo e(route('exportexcel_pns')); ?>"> Export Excel</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $showdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="<?php echo e(route('data-pns.destroy', $value->id_pns)); ?>"
                                                    method="POST">
                                                    <a class="btn btn-info"
                                                        href="<?php echo e(route('data-pns.show', $value->id_pns)); ?>">Lihat</a>
                                                    <a class="btn btn-primary"
                                                        href="<?php echo e(route('data-pns.edit', $value->id_pns)); ?>">Ubah</a>
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-kepegawaian-hillcipher\resources\views/admin/data-pns.blade.php ENDPATH**/ ?>