            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('data-subbidang.index')); ?>">Data Sub Bidang</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo e(route('data-subbidang.update', $datanya->id_sub_bidang)); ?>" method="POST"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_sub_bidang" class="form-control"
                                                    placeholder="Nama Bidang" value="<?php echo e($datanya->nama_sub_bidang); ?>"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="singkatan" class="form-control"
                                                    placeholder="Singkatan" value="<?php echo e($datanya->singkatan); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-kepegawaian-hillcipher\resources\views/admin/ubah-subbidang.blade.php ENDPATH**/ ?>