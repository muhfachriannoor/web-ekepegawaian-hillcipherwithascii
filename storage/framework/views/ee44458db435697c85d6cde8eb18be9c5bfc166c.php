            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-12 mt-3">
                    <div class="float-left">
                        <a class="btn btn-success" href="<?php echo e(route('data-bidang.create')); ?>"> Tambah Data</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $showdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($value->nama_bidang); ?></td>
                                            <td><?php echo e($value->singkatan); ?></td>
                                            <td>
                                                <form action="<?php echo e(route('data-bidang.destroy', $value->id_bidang)); ?>"
                                                    method="POST">
                                                    
                                                    <a class="btn btn-primary"
                                                        href="<?php echo e(route('data-bidang.edit', $value->id_bidang)); ?>">Ubah</a>
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin/templatedashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-kepegawaian-hillcipher\resources\views/admin/data-bidang.blade.php ENDPATH**/ ?>